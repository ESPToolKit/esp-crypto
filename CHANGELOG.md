...
- Updated AES-GCM streaming shims to match the ESP32 Arduino 3.3.x `esp_aes_gcm_*` signatures (starts/update/finish), avoiding Arduino CLI build failures on `advanced_primitives`.
